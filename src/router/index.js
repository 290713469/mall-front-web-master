...
const aboutUs = () => import('/page/CommonInfo/aboutUs.vue')
const ipCopyright = () => import('/page/CommonInfo/ipCopyright.vue')
const returnRefund = () => import('/page/CommonInfo/returnRefund.vue')
const privacy = () => import('/page/CommonInfo/privacy.vue')
const shipLocation = () => import('/page/CommonInfo/shipLocation.vue')
const customDuty = () => import('/page/CommonInfo/customDuty.vue')
const faq = () => import('/page/CommonInfo/faq.vue')
const customerService = () => import('/page/CommonInfo/customerService.vue')
Vue.use(Router)
  ...
  routes: [
    {
      ...
      children: [
        ...
        {path: 'item', component: GoodS},
        {path: 'goodsDetails', name: 'goodsDetails', component: goodsDetails},
        {path: 'thanks', name: 'thanks', component: Thanks},
        {path: 'aboutUs', name: 'aboutUs', component: aboutUs},
        {path: 'ipCopyright', name: 'ipCopyright', component: ipCopyright},
        {path: 'returnRefund', name: 'returnRefund', component: returnRefund},
        {path: 'privacy', name: 'privacy', component: privacy},
        {path: 'shipLocation', name: 'shipLocation', component: shipLocation},
        {path: 'customDuty', name: 'customDuty', component: customDuty},
    ...
    {path: '/item', name: 'item', component: GoodS},
    {
      path: '/order',
      name: 'order',
      component: order,
