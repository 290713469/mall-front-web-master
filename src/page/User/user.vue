...
<script>
  ...
  export default {
    data () {
      return {
        title: this.$t('common.my_order'),
        nav: [
          {name: this.$t('common.my_order'), path: 'orderList'},
          {name: this.$t('user.account_info'), path: 'information'},
          {name: this.$t('common.address'), path: 'addressList'}
        ],
        editAvatar: true
      }
    },
