  ...
  <div class="goods">
      ...
      <div class="nav-sub-wrappers">
        <div class="w">
          <ul class="nav-lists">
            ...
            <li>
              <a class="active">{{$t("search.search_result")}}</a>
            </li>
            <li>
              <a v-if="searching === true">{{$t("search.searching")}}</a>
              <a v-if="searching === false">{{$t("search.search_result_msg_prefix")}} {{total}} {{$t("search.search_result_msg_suffix")}}</a>
            </li>
          </ul>
          <div></div>
        </div>
    ...
    <div class="nav">
      <div class="w">
        ...
        <a href="javascript:;" @click="sortByPrice(1)" :class="{active:sortType===2}">{{$t("goods.order_price_asc")}}</a>
        <a href="javascript:;" @click="sortByPrice(-1)" :class="{active:sortType===3}">{{$t("goods.order_price_desc")}}</a>
    ...
    <div v-loading="loading" :element-loading-text="$t('goods.loading')" style="min-height: 35vw;">
