...
export const getAllGoodsByCategory = (params) => {
  return http.fetchGet('/goods/allGoodsByCategory', params)
}

export const getAllGoodsByParentCategory = (params) => {
  return http.fetchGet('/goods/allGoodsByParentCategory', params)
}

export const orderMinPrice = (params) => {
  return http.fetchGet('/order/minPrice', params)
}

export const getItemCategoryByParentType = (params) => {
  return http.fetchGet('/item/subCategoryList', params)
}
// 获取购物车列表
...
export const getAllCountries = (params) => {
  return http.fetchGet('/express/getAllCountries', params)
}

export const getAllExpressFees = (params) => {
  return http.fetchGet('/express/getAllExpressFees', params)
}

export const getGoodsPriceList = (params) => {
  return http.fetchGet('/goods/getPriceList', params)
}
