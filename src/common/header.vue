<template>
  <div class="header-box">
    <div>
      <header class="w">
        <div class="w-box">
          <div class="nav-logo" style="width: 30%">
            <!--<h1 @click="changePage(-1)">
              <span style="color: white; font-size: 26px"><router-link to="/" style="color: white !important;">YiWu-Express</router-link></span>
            </h1>-->
            <h1 @click="changePage(-1)">
              <router-link to="/" title="YiWu-Express">YiWu-Express</router-link>
            </h1>
          </div>
          <!--<div>
            <el-select v-model="currentLanguage" @change="selectLanguage">
              <el-option v-for="option in options" :key="option" :lable="option" :value="option"></el-option>
            </el-select>
          ...
          <div class="right-box">
            <div class="nav-list">
              <el-autocomplete
                :placeholder="$t('common.search_goods_placeholder')"
                icon="search"
                v-model="input"
                minlength=1
                maxlength=100
              ...
              <!--<router-link to="/goods"><a @click="changePage(2)">{{$t("common.home")}}</a></router-link>-->
            ...
            <div class="nav-aside" ref="aside" :class="{fixed:st}">
              <div class="user pr">
                <router-link to="/user">{{$t("common.personal_information")}}</router-link>
                <!--用户信息显示-->
                <div class="nav-user-wrapper pa" v-if="login">
                  <div class="nav-user-list">
                    <ul>
                      ...
                      <li>
                        <router-link to="/user/orderList">{{$t("common.my_order")}}</router-link>
                      </li>
                      <li>
                        <router-link to="/user/information">{{$t("common.account_information")}}</router-link>
                      </li>
                      <li>
                        <router-link to="/user/addressList">{{$t("common.address")}}</router-link>
                      </li>
                      <!--<li>
                      ...
                      <li>
                        <a href="javascript:;" @click="_loginOut">{{$t("common.logout")}}</a>
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div class="nav-user-wrapper pa active" v-show="showCart">
                  <div class="nav-user-list">
                    <div class="full" v-show="totalNum">
                                ...
                                <a @click="openProduct(item.productId)">
                                  ...
                                  <div class="item-desc">
                                    <div class="cart-cell"><h4>
                                      ...
                                      <h6><span class="price-icon">{{$t("cart.cash_symbol")}}</span><span
                                        class="price-num">{{item.salePrice}}</span><span
                                        class="item-num">* {{item.buyNum}}</span>
                                      </h6></div>
                                  </div>
                                </a>
                                <div class="del-btn del" @click="delGoods(item.productId, i)">{{$t("common.delete")}}</div>
                              </div>
                            </div>
                          </li>
                        </ul>
                      ...
                      <!--总件数-->
                      <div class="nav-cart-total"><!--<p>共 <strong>{{totalNum}}</strong> 件商品</p>--> <h5>{{$t("common.total_price")}}：<span
                        class="price-icon">{{$t("cart.cash_symbol")}}</span><span
                        ...
                        <h6>
                          <y-button classStyle="main-btn"
                                    ...
                                    :text="$t('common.gotoCart')" @btnClick="toCart"></y-button>
                        </h6>
                      </div>
                    </div>
...
<script>
  ...
  export default{
    ...
    methods: {
      ...
      selectLanguage () {
        localStorage.setItem('user-language', this.currentLanguage === 'English' ? 'en' : 'zh')
        this.$i18n.locale = this.currentLanguage === 'English' ? 'en' : 'zh'
      },
      showError (m) {
        this.$message.error({
          message: m
...
<style lang="scss" rel="stylesheet/scss" scoped>
  ...
  .w-box {
    ...
    h1 {
      ...
      align-items: center;
      > a {
        background: url(/static/images/logo.jpg) no-repeat 50%;
        background-size: cover;
        display: block;
        @include wh(80px, 100px);
        text-indent: -9999px;
